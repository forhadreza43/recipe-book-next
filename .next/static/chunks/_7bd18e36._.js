...
const getImageUrlImgBB = async (imageData)=>{
    ...
    const response = await fetch("https://api.imgbb.com/1/upload?key=".concat(("TURBOPACK compile-time value", "4afac0e722d8dcb56926c628da6d87cb")), {
        method: "POST",
        body: imageFormData
    });
    if (!response.ok) {
...
const getImageUrlCloudinary = async (imageFile)=>{
    ...
    const response = await fetch("https://api.cloudinary.com/v1_1/".concat(("TURBOPACK compile-time value", "dqs6k0so6"), "/image/upload"), {
        method: "POST",
        body: formData
    });
    if (!response.ok) {
...
//# sourceMappingURL=_7bd18e36._.js.map
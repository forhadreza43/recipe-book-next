...
function Register() {
    ...
    const handleRegister = async (e)=>{
        ...
        try {
            ...
            const res = await fetch("".concat(("TURBOPACK compile-time value", "https://recipe-book-app-server-chi.vercel.app"), "/auth/register"), {
                method: "POST",
                headers: {
...
_s(Register, "kqi16TGQ4fhIno2ZDV41696ZwZo=", false, function() {
    return [

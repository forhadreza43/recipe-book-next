...
"[project]/components/TopRecipes.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const TopRecipes = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TopRecipes.useEffect": ()=>{
            let isMounted = true;
            const loadTopRecipes = {
                "TopRecipes.useEffect.loadTopRecipes": async ()=>{
                    try {
                        setIsLoading(true);
            ...
            }["TopRecipes.useEffect.loadTopRecipes"];
            loadTopRecipes();
            return ({
                "TopRecipes.useEffect": ()=>{
                    isMounted = false;
...
_s(TopRecipes, "WYkTC8mahA2FNgDOKGxm5E3fep0=");
_c = TopRecipes;
const __TURBOPACK__default__export__ = TopRecipes;
var _c;
__turbopack_context__.k.register(_c, "TopRecipes");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_91d0698c._.js.map